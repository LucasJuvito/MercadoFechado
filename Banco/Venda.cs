...
namespace ServidorTestes.Banco
{
    class Venda
    {
        ...
        public static List<Venda> ListarVendasPessoais(long idUser)
        {
            using MySqlConnection connection = new MySqlConnection(Global.DBConnectionBuilder.ConnectionString);
            connection.Open();

            using MySqlCommand command = connection.CreateCommand();
            command.CommandText = "SELECT id_venda, valor, venda_hora, endereco_entrega, comprador, id_anuncio " +
                "FROM venda " +
        ...
        public static List<Venda> ListarComprasPessoais(long idUser)
        {
            using MySqlConnection connection = new MySqlConnection(Global.DBConnectionBuilder.ConnectionString);
            connection.Open();

            using MySqlCommand command = connection.CreateCommand();
            command.CommandText = "SELECT id_venda, valor, venda_hora, endereco_entrega, vendedor, id_anuncio " +
                "FROM venda " +
